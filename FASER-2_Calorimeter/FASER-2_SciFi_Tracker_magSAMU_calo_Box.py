...
#Magnet
    ...
    bx_calo_em = pyg4ometry.gdml.Constant("bx_calo_em","2000",reg,True)
    by_calo_em = pyg4ometry.gdml.Constant("by_calo_em","2000",reg,True)
    bz_calo_em = pyg4ometry.gdml.Constant("bz_calo_em","370",reg,True)
    z_calo_em = pyg4ometry.gdml.Constant("z_calo_em","21000",reg,True)

    # bx_calo_had = pyg4ometry.gdml.Constant("bx_calo_had","3500",reg,True)
    # by_calo_had = pyg4ometry.gdml.Constant("by_calo_had","1500",reg,True)
    bz_calo_had = pyg4ometry.gdml.Constant("bz_calo_had","2500",reg,True)
    #z_calo_had = pyg4ometry.gdml.Constant("z_calo_had","40",reg,True)
    ...
    Calo_em   = pyg4ometry.geant4.solid.Box("Calo_em", bx_calo_em, by_calo_em, bz_calo_em,reg)
    Calo_emLV = pyg4ometry.geant4.LogicalVolume(Calo_em,"G4_Cu","Calo_emLV",reg)
    Calo_em_PV = pyg4ometry.geant4.PhysicalVolume([0, 0, 0], [0, 0,z_calo_em], Calo_emLV, "Calo_em_PV", worldLV, reg)

    Calo_had   = pyg4ometry.geant4.solid.Box("Calo_had", bx_calo_em, by_calo_em, bz_calo_had,reg)
    Calo_hadLV = pyg4ometry.geant4.LogicalVolume(Calo_had,"G4_Zn","Calo_hadLV",reg)
    Calo_had_PV = pyg4ometry.geant4.PhysicalVolume([0, 0, 0], [0, 0,z_calo_em+ bz_calo_em/2+0.5*bz_calo_had], Calo_hadLV, "Calo_had_PV", worldLV, reg)
    ...
    w.addDetector(reg)
    w.write("SciFi_3Trk_mag_calo.gdml")

    v=None
    if vis :

       # v_c = pyg4ometry.visualisation.VtkViewerColoured(materialVisOptions={"G4_Fe":[0,0,1],nbti:[1,0,1],Fiberm:[0,1,1]})
        v_c = pyg4ometry.visualisation.VtkViewerColoured(materialVisOptions={"G4_Nb":[1,0,0.6],"G4_Fe":[0,0,1],"G4_Cu":[0.8,0,0],"G4_Zn":[0.44,0.3,0.13]})
