...
#downstream
    ...
    SciFi_Trk_us_vertPV1_Extra = pyg4ometry.geant4.PhysicalVolume([0,0,0],[0,0, d1_us+d_layers], SciFiLv_vert_us,"SciFi_Trk_us_vertPV1_Extra",worldLV,reg)
    SciFi_Trk_us_vertPV1_Extra2 = pyg4ometry.geant4.PhysicalVolume([0,0,0],[0,0, d1_us+d_layers+d_hor_vert], SciFiLv_vert_us,"SciFi_Trk_us_vertPV1_Extra2",worldLV,reg)

    SciFi_Trk_us_vertPV2 = pyg4ometry.geant4.PhysicalVolume([0,0,_np.pi/180],[0,0, d1_us+2*d_layers], SciFiLv_vert_us,"SciFi_Trk_us_vertPV2",worldLV,reg)
    SciFi_Trk_us_horizPV2 = pyg4ometry.geant4.PhysicalVolume([0,0,0],[0,0, d1_us+2*d_layers+d_hor_vert], SciFiLv_hor,"SciFi_Trk_us_horizPV2",worldLV,reg)

    SciFi_Trk_us_vertPV2_Extra = pyg4ometry.geant4.PhysicalVolume([0,0,0],[0,0, d1_us+3*d_layers], SciFiLv_vert_us,"SciFi_Trk_us_vertPV2_Extra",worldLV,reg)
    SciFi_Trk_us_horizPV2_Extra2 = pyg4ometry.geant4.PhysicalVolume([0,0,0],[0,0, d1_us+3*d_layers+d_hor_vert], SciFiLv_vert_us,"SciFi_Trk_us_vertPV2_Extra2",worldLV,reg)

    SciFi_Trk_us_vertPV3 = pyg4ometry.geant4.PhysicalVolume([0,0,2*_np.pi/180],[0,0, d1_us+4*d_layers], SciFiLv_vert_us,"SciFi_Trk_us_vertPV3",worldLV,reg)
    SciFi_Trk_us_horizPV3 = pyg4ometry.geant4.PhysicalVolume([0,0,0],[0,0, d1_us+4*d_layers+d_hor_vert], SciFiLv_hor,"SciFi_Trk_us_horizPV3",worldLV,reg)
...
#upstream
    ...
    SciFi_Trk_ds_vertPV1_Extra = pyg4ometry.geant4.PhysicalVolume([0,0,_np.pi/180],[0,0, d1_ds+1*d_layers], SciFiLv_vert_ds,"SciFi_Trk_ds_vertPV1_Extra",worldLV,reg)
    SciFi_Trk_ds_vertPV1_Extra2 = pyg4ometry.geant4.PhysicalVolume([0,0,0],[0,0, d1_ds+1*d_layers+d_hor_vert], SciFiLv_vert_ds,"SciFi_Trk_ds_vertPV1_Extra2",worldLV,reg)

    SciFi_Trk_ds_vertPV2 = pyg4ometry.geant4.PhysicalVolume([0,0,_np.pi/180],[0,0, d1_ds+2*d_layers], SciFiLv_vert_ds,"SciFi_Trk_ds_vertPV2",worldLV,reg)
    SciFi_Trk_ds_horizPV2 = pyg4ometry.geant4.PhysicalVolume([0,0,0],[0,0, d1_ds+2*d_layers+d_hor_vert], SciFiLv_hor,"SciFi_Trk_ds_horizPV2",worldLV,reg)

    SciFi_Trk_ds_vertPV2_Extra = pyg4ometry.geant4.PhysicalVolume([0,0,0],[0,0, d1_ds+3*d_layers], SciFiLv_vert_ds,"SciFi_Trk_ds_vertPV2_Extra",worldLV,reg)
    SciFi_Trk_ds_vertPV2_Extra2 = pyg4ometry.geant4.PhysicalVolume([0,0,_np.pi/180],[0,0, d1_ds+3*d_layers+d_hor_vert], SciFiLv_vert_ds,"SciFi_Trk_ds_vertPV2_Extra2",worldLV,reg)

    SciFi_Trk_ds_vertPV3 = pyg4ometry.geant4.PhysicalVolume([0,0,0],[0,0, d1_ds+4*d_layers], SciFiLv_vert_ds,"SciFi_Trk_ds_vertPV3",worldLV,reg)
    SciFi_Trk_ds_horizPV3 = pyg4ometry.geant4.PhysicalVolume([0,0,0],[0,0, d1_ds+4*d_layers+d_hor_vert], SciFiLv_hor,"SciFi_Trk_ds_horizPV3",worldLV,reg)


#    Mag=pyg4ometry.geant4.solid.Box("Mag",1000,3000,4000,reg)
#    Mag_LV=pyg4ometry.geant4.LogicalVolume(Mag,"G4_Fe","Mag_LV",reg)
#    Mag_PV=pyg4ometry.geant4.PhysicalVolume([0,0,0],[0,0,12000],Mag_LV,"Mag_PV",worldLV,reg)
    ...
    w.addDetector(reg)
    w.write("SciFi_mag_Trk_Extra.gdml")

    v=None
    if vis :

        v_c = pyg4ometry.visualisation.VtkViewerColoured(materialVisOptions={"G4_Fe":[0,0,1]})
