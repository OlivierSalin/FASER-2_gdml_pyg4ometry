...
def SciFiTrackerLayer(reg = None) :
    ...
    SciFiLv_vert_us = pyg4ometry.geant4.LogicalVolume(SciFi_Trk_vert_us,"G4_Fe","SciFiLv_vert_us",reg)
    ...
    SciFiLv_vert_ds = pyg4ometry.geant4.LogicalVolume(SciFi_Trk_vert_ds,"G4_Fe","SciFiLv_vert_ds",reg)
    SF_LV.append(SciFiLv_vert_ds)

    SciFi_Trk_hor   = pyg4ometry.geant4.solid.Box("SciFi_Trk_hor", bx_hor, by_hor, bz_hor,reg)
    SciFiLv_hor = pyg4ometry.geant4.LogicalVolume(SciFi_Trk_hor,"G4_Fe","SciFiLv_hor",reg)
