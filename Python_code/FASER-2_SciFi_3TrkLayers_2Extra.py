...
def SciFiTracker(vis= False):
    ...
    d1_ds = pyg4ometry.gdml.Constant("d1_ds","10500",reg,True)
...
#	SciFi_Trk_vertPV = pyg4ometry.geant4.PhysicalVolume([0,k*_np.pi/180,0],[0,0, d1_ds+k*d_layers], SciFiLv,"SciFi_Trk_vertPV",worldLV,reg)
#       SciFi_Trk_horizPV = pyg4ometry.geant4.PhysicalVolume([0,_np.pi/2,0],[0,0, d1_ds+k*d_layers+d_hor_vert], SciFiLv,"SciFi_Trk_horizPV",worldLV,reg)
    ...
    SciFi_Trk_ds_Extra_vertPV1 = pyg4ometry.geant4.PhysicalVolume([0,_np.pi/180,0],[0,0, d1_ds+d_layers], SciFiLv,"SciFi_Trk_ds_Extra_vertPV1",worldLV,reg)
    SciFi_Trk_ds_Extra2_vertPV1 = pyg4ometry.geant4.PhysicalVolume([0,2*_np.pi/180,0],[0,0, d1_ds+d_layers+d_hor_vert], SciFiLv,"SciFi_Trk_ds_Extra2_vertPV1",worldLV,reg)

    SciFi_Trk_ds_vertPV2 = pyg4ometry.geant4.PhysicalVolume([0,3*_np.pi/180,0],[0,0, d1_ds+2*d_layers], SciFiLv,"SciFi_Trk_ds_vertPV2",worldLV,reg)
    SciFi_Trk_ds_horizPV2 = pyg4ometry.geant4.PhysicalVolume([0,_np.pi/2,0],[0,0, d1_ds+2*d_layers+d_hor_vert], SciFiLv,"SciFi_Trk_ds_horizPV2",worldLV,reg)

    SciFi_Trk_ds_Extra_vertPV2 = pyg4ometry.geant4.PhysicalVolume([0,4*_np.pi/180,0],[0,0, d1_ds+3*d_layers], SciFiLv,"SciFi_Trk_ds_Extra_vertPV2",worldLV,reg)
    SciFi_Trk_ds_Extra2_vertPV2 = pyg4ometry.geant4.PhysicalVolume([0,5*_np.pi/180,0],[0,0, d1_ds+3*d_layers+d_hor_vert], SciFiLv,"SciFi_Trk_ds_Extra2_vertPV2",worldLV,reg)

    SciFi_Trk_ds_vertPV3 = pyg4ometry.geant4.PhysicalVolume([0,6*_np.pi/180,0],[0,0, d1_ds+4*d_layers], SciFiLv,"SciFi_Trk_ds_vertPV3",worldLV,reg)
    SciFi_Trk_ds_horizPV3 = pyg4ometry.geant4.PhysicalVolume([0,_np.pi/2,0],[0,0, d1_ds+4*d_layers+d_hor_vert], SciFiLv,"SciFi_Trk_ds_horizPV3",worldLV,reg)
...
#       SciFi_Trk_horizPV = pyg4ometry.geant4.PhysicalVolume([0,_np.pi/2,0],[0,0,d1_ds+k*d_layers +d_hor_vert], SciFiLv,"SciFi_Trk_horizPV",worldLV,reg)
    ...
    SciFi_Trk_us_Extra_vertPV1 = pyg4ometry.geant4.PhysicalVolume([0,_np.pi/180,0],[0,0, d1_us+d_layers], SciFiLv,"SciFi_Trk_us_Extra_vertPV1",worldLV,reg)
    SciFi_Trk_us_Extra2_vertPV1 = pyg4ometry.geant4.PhysicalVolume([0,2*_np.pi/180,0],[0,0, d1_us+d_layers+d_hor_vert], SciFiLv,"SciFi_Trk_us_Extra2_vertPV1",worldLV,reg)

    SciFi_Trk_us_vertPV2 = pyg4ometry.geant4.PhysicalVolume([0,3*_np.pi/180,0],[0,0, d1_us+2*d_layers], SciFiLv,"SciFi_Trk_us_vertPV2",worldLV,reg)
    SciFi_Trk_us_horizPV2 = pyg4ometry.geant4.PhysicalVolume([0,_np.pi/2,0],[0,0, d1_us+2*d_layers+d_hor_vert], SciFiLv,"SciFi_Trk_us_horizPV2",worldLV,reg)

    SciFi_Trk_us_Extra_vertPV2 = pyg4ometry.geant4.PhysicalVolume([0,4*_np.pi/180,0],[0,0, d1_us+3*d_layers], SciFiLv,"SciFi_Trk_us_Extra_vertPV2",worldLV,reg)
    SciFi_Trk_us_Extra2_vertPV2 = pyg4ometry.geant4.PhysicalVolume([0,5*_np.pi/180,0],[0,0, d1_us+3*d_layers+d_hor_vert], SciFiLv,"SciFi_Trk_us_Extra2_vertPV2",worldLV,reg)

    SciFi_Trk_us_vertPV3 = pyg4ometry.geant4.PhysicalVolume([0,6*_np.pi/180,0],[0,0, d1_us+4*d_layers], SciFiLv,"SciFi_Trk_us_vertPV3",worldLV,reg)
    SciFi_Trk_us_horizPV3 = pyg4ometry.geant4.PhysicalVolume([0,_np.pi/2,0],[0,0, d1_us+4*d_layers+d_hor_vert], SciFiLv,"SciFi_Trk_us_horizPV3",worldLV,reg)
