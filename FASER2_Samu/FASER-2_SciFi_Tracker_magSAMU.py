...
def SciFiTracker(vis= False):
    ...
    worldSolid = pyg4ometry.geant4.solid.Box("world_solid",70000,100000,410000,reg,"mm")
...
#Magnet
    ...
    z_mag = pyg4ometry.gdml.Constant("z_mag", 12000, reg)
    ...
    if vis :
       ...
       # v_c.setWireframe(-1)
        v_c.addAxesWidget()
        v_c.exportOBJScene('SciFi_6trk_obj')
        v_c.view()
